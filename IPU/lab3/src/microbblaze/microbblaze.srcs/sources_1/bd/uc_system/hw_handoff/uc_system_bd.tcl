...
proc create_root_design { parentCell } {
  ...
  set clk_mb [ create_bd_port -dir I -type clk clk_mb ]
  set_property -dict [ list \
   CONFIG.FREQ_HZ {100000000} \
 ] $clk_mb
  set outs [ create_bd_port -dir O outs ]
  set reset_mb [ create_bd_port -dir I -type rst reset_mb ]
  set_property -dict [ list \
  ...
  # Create port connections
  connect_bd_net -net axi_bram_ctrl_0_bram_addr_a [get_bd_pins axi_bram_ctrl_0/bram_addr_a] [get_bd_pins bram_interconnect_0/addr_bi]
  connect_bd_net -net axi_bram_ctrl_0_bram_clk_a [get_bd_pins axi_bram_ctrl_0/bram_clk_a] [get_bd_pins bram_interconnect_0/clk_i] [get_bd_pins output_compare_0/clk_i] [get_bd_pins timer_0/clk_i] [get_bd_pins timer_1/clk_i]
  connect_bd_net -net axi_bram_ctrl_0_bram_en_a [get_bd_pins axi_bram_ctrl_0/bram_en_a] [get_bd_pins bram_interconnect_0/en_i]
  connect_bd_net -net axi_bram_ctrl_0_bram_rst_a [get_bd_pins axi_bram_ctrl_0/bram_rst_a] [get_bd_pins bram_interconnect_0/rst_i] [get_bd_pins output_compare_0/rst_i] [get_bd_pins timer_0/rst_i] [get_bd_pins timer_1/rst_i]
  connect_bd_net -net axi_bram_ctrl_0_bram_we_a [get_bd_pins axi_bram_ctrl_0/bram_we_a] [get_bd_pins bram_interconnect_0/we_bi]
  connect_bd_net -net axi_bram_ctrl_0_bram_wrdata_a [get_bd_pins axi_bram_ctrl_0/bram_wrdata_a] [get_bd_pins bram_interconnect_0/wrdata_bi]
  connect_bd_net -net bram_interconnect_0_rddata_bo [get_bd_pins axi_bram_ctrl_0/bram_rddata_a] [get_bd_pins bram_interconnect_0/rddata_bo]
  connect_bd_net -net bram_interconnect_0_s1_addr_bo [get_bd_pins bram_interconnect_0/s1_addr_bo] [get_bd_pins output_compare_0/addr_i]
  connect_bd_net -net bram_interconnect_0_s1_en_o [get_bd_pins bram_interconnect_0/s1_en_o] [get_bd_pins output_compare_0/en_i]
  connect_bd_net -net bram_interconnect_0_s1_we_bo [get_bd_pins bram_interconnect_0/s1_we_bo] [get_bd_pins output_compare_0/we_i]
  connect_bd_net -net bram_interconnect_0_s1_wrdata_bo [get_bd_pins bram_interconnect_0/s1_wrdata_bo] [get_bd_pins output_compare_0/data_i]
  connect_bd_net -net bram_interconnect_0_s2_addr_bo [get_bd_pins bram_interconnect_0/s2_addr_bo] [get_bd_pins timer_0/addr_i]
  connect_bd_net -net bram_interconnect_0_s2_en_o [get_bd_pins bram_interconnect_0/s2_en_o] [get_bd_pins timer_0/en_i]
  connect_bd_net -net bram_interconnect_0_s2_we_bo [get_bd_pins bram_interconnect_0/s2_we_bo] [get_bd_pins timer_0/we_i]
  connect_bd_net -net bram_interconnect_0_s2_wrdata_bo [get_bd_pins bram_interconnect_0/s2_wrdata_bo] [get_bd_pins timer_0/data_i]
  connect_bd_net -net bram_interconnect_0_s3_addr_bo [get_bd_pins bram_interconnect_0/s3_addr_bo] [get_bd_pins timer_1/addr_i]
  connect_bd_net -net bram_interconnect_0_s3_en_o [get_bd_pins bram_interconnect_0/s3_en_o] [get_bd_pins timer_1/en_i]
  connect_bd_net -net bram_interconnect_0_s3_we_bo [get_bd_pins bram_interconnect_0/s3_we_bo] [get_bd_pins timer_1/we_i]
  connect_bd_net -net bram_interconnect_0_s3_wrdata_bo [get_bd_pins bram_interconnect_0/s3_wrdata_bo] [get_bd_pins timer_1/data_i]
  connect_bd_net -net capturetrig_1 [get_bd_ports capturetrig] [get_bd_pins axi_timer_0/capturetrig0] [get_bd_pins axi_timer_0/capturetrig1]
  connect_bd_net -net clk_100MHz_1 [get_bd_ports clk_mb] [get_bd_pins clk_wiz_0/clk_in1]
  ...
  connect_bd_net -net output_compare_0_data_o [get_bd_pins bram_interconnect_0/s1_rddata_bi] [get_bd_pins output_compare_0/data_o]
  connect_bd_net -net output_compare_0_outs [get_bd_ports outs] [get_bd_pins output_compare_0/outs]
  ...
  connect_bd_net -net reset_rtl_0_1 [get_bd_ports reset_mb] [get_bd_pins clk_wiz_0/reset] [get_bd_pins proc_sys_reset_0/ext_reset_in]
  connect_bd_net -net timer_0_data_o [get_bd_pins bram_interconnect_0/s2_rddata_bi] [get_bd_pins timer_0/data_o]
  connect_bd_net -net timer_0_tm_of [get_bd_pins output_compare_0/tm1_of] [get_bd_pins timer_0/tm_of]
  connect_bd_net -net timer_0_tval_o [get_bd_pins output_compare_0/tm1] [get_bd_pins timer_0/tval_o]
  connect_bd_net -net timer_1_data_o [get_bd_pins bram_interconnect_0/s3_rddata_bi] [get_bd_pins timer_1/data_o]
  connect_bd_net -net timer_1_tm_of [get_bd_pins output_compare_0/tm2_of] [get_bd_pins timer_1/tm_of]
  connect_bd_net -net timer_1_tval_o [get_bd_pins output_compare_0/tm2] [get_bd_pins timer_1/tval_o]
