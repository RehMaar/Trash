...
public class EvaluateSiteFillEmail {
  ...
  @Test
  public void testEvaluateSiteFillEmail() throws Exception {
    ...
    driver.findElement(By.name("UserEmail")).sendKeys("sdfghjkl;");
    driver.findElement(By.cssSelector("input[type=\"submit\"]")).click();
    assertEquals("Проверьте корректность email", driver.findElement(By.xpath("//tr[2]/td/table/tbody/tr/td[2]")).getText());
  }
