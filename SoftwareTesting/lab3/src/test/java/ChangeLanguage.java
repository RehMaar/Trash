...
public class ChangeLanguage {
  ...
  public void testChangeLanguage() throws Exception {
    driver.get(baseUrl + "/c/m.exe?a=2&l1=3&l2=2");
    ...
    driver.findElement(By.cssSelector("img[alt=\"Multitran dictionary\"]")).click();
    driver.findElement(By.linkText("По-русски")).click();
    driver.findElement(By.cssSelector("img[alt=\"Forum\"]")).click();
  }
